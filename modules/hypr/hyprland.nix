{
  ...
  xdg.configFile = {
    "wofi/style.css".source = ../dotfiles/.config/hypr/style.css;
    "wofi/style.scss".source = ../dotfiles/.config/hypr/style.scss;
    ".kde-dark-kuroi.qss".source = ../dotfiles/.config/hypr/kde-dark-kuroi.qss;
  };
